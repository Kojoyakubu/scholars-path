  ...
  return (
    ...
    >
      ...
      <g transform="translate(50, 50)">
        ...
        <circle cx="0" cy="0" r="38" fill="#2563EB" opacity="0.1"/>
        <circle cx="0" cy="0" r="36" fill="#2563EB" opacity="0.08"/>
        
        {/* Book with Path */}
        <g transform="translate(-15, -5)">
          {/* Open Book */}
          <path d="M 0 15 Q 7.5 10, 15 15 L 15 0 Q 7.5 -2, 0 0 Z" fill="#2563EB"/>
          <path d="M 15 15 Q 22.5 10, 30 15 L 30 0 Q 22.5 -2, 15 0 Z" fill="#2563EB" opacity="0.8"/>
        ...
        <g transform="translate(-10, -22)">
          <rect x="0" y="0" width="20" height="2" fill="#2563EB" rx="0.5"/>
          <path d="M 10 -5 L 16 -2.5 L 10 0 L 4 -2.5 Z" fill="#F59E0B"/>
          <line x1="10" y1="-5" x2="13" y2="-8" stroke="#F59E0B" strokeWidth="1.5" strokeLinecap="round"/>
        ...
        <g transform="translate(8, 10)">
          <path 
            ...
            opacity="0.5"
          />
          <circle cx="0" cy="0" r="2" fill="#2563EB" opacity="0.7"/>
          <circle cx="5" cy="-5" r="2" fill="#2563EB" opacity="0.7"/>
          <circle cx="8" cy="-12" r="1.5" fill="#2563EB" opacity="0.6"/>
        </g>
      </g>
